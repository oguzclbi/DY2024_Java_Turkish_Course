package day00_homeworks.hw11_sms;
...
public class StudentManagement {
    ...
    public void deleteStudentWithId(int studentId){
        for (Student student : this.students) {
            ...
            if (student.id==studentId){
                ...
                System.out.println(studentId+" numaralı öğrenci listeden silinmiştir.");
                break;
            }
    ...
    public Student getStudentWithId(int studentId){
        ...
        System.out.println(studentId+" numaralı öğrenci listede bulunamadı");
        return null;
    }
